...
Register RegisterAddress;
    ...
    function initialize(IERC20Upgradeable _token, address _registerAddress) public initializer {
        token = _token;
...
RegisterAddress=Register(_registerAddress);
    ...
    function incrementAndGet() internal virtual override  returns (uint256) {
        ...
        returns (uint256 suspensionDays, bool ban)
    {
        ...
        if (violation.count <= numberOfExcuses) {
            RegisterAddress.SuspendUser(post.creator);
            ...
            return (suspensionPeriod, false);
                        ...
                        RegisterAddress.BanUser(post.creator);
